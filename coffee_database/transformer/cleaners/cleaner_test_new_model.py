...
for roaster in tqdm(roaster_list, desc="Processing roasters"):
    ...
    # df.to_sql(name = 'transformed_stg_test' , con=conn, index=False, if_exists='append',dtype=type_col,schema='public')
    df.to_sql(name = 'transformed_stg_test' , con=conn, index=False, if_exists='append',schema='public')
